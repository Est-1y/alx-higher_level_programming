...
class TestRectangle(unittest.TestCase):
    ...
    # testing for the valid initializations
    ...
    def test_invalid_width_init(self):
        '''testing for initialization of non-int width'''
    ...
    def test_invalid_height_init(self):
        '''testing for the initialization of non-int height'''
        with self.assertRaises(TypeError) as e:
    ...
    def test_negative_height_value(self):
        '''testing for when height has negative value'''
        with self.assertRaises(ValueError) as e:
            r = Rectangle(12, -3)
    ...
    def test_x_not_int(self):
        '''testing for when x is not integer'''
        with self.assertRaises(TypeError) as e:
    ...
    def test_y_not_int(self):
        '''testing for when y is not integer'''
        with self.assertRaises(TypeError) as e:
    ...
    def test_neg_x(self):
        '''testing for when x is negative'''
        with self.assertRaises(ValueError) as e:
    ...
    def test_zero_x(self):
        '''test for if x and y are 0'''
        r = Rectangle(2, 17, 0, 0)
        self.assertEqual(r.x, 0)
        self.assertEqual(r.y, 0)

    def test_neg_y(self):
        '''test for when y is negative.'''
        with self.assertRaises(ValueError) as e:
            r = Rectangle(2, 10, 1, -1)
    ...
    # test for setting values with valid and invalid values.
    ...
    def test_set_height_invalid(self):
        '''testing the setting invalid height'''
        r = Rectangle(4, 10)
        with self.assertRaises(ValueError) as e:
            r.height = -5
    ...
    # testing for the invalid input, type error
    def test_set_width_invalid(self):
        '''testing the setting invalid width'''
        r = Rectangle(4, 10)
        with self.assertRaises(TypeError) as e:
            r.width = 'invalid'
